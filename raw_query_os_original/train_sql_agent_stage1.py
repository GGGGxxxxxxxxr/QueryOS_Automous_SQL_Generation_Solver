...
import pandas as pd
from schema_discovery_agent import LitSchemaDiscoveryAgent
...
RL_TRAINING_CONFIG: Dict[str, Any] = {
    ...
    "data": {
        "train_files": "/efs/open_source_sql_agentic_rl/agent-lightning/examples/spider2/rl_data_spider2/locating_tables/table_locating_train.parquet",
        "val_files": "/efs/open_source_sql_agentic_rl/agent-lightning/examples/spider2/rl_data_spider2/locating_tables/table_locating_val.parquet",
        "train_batch_size": 8,
    ...
    "trainer": {
        ...
        "experiment_name": "spider_stage1",
        "default_local_dir": '/efs/open_source_sql_agentic_rl/agent-lightning/examples/spider2/stage1/',
        "nnodes": 1,
        "test_freq": 5,
        "save_freq": 5,
        "total_epochs": 100,
