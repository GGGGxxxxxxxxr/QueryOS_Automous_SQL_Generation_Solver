...
import pandas as pd
from sql_writer import LitSQLWriterAgent
...
RL_TRAINING_CONFIG: Dict[str, Any] = {
    ...
    "data": {
        "train_files": "/efs/open_source_sql_agentic_rl/agent-lightning/examples/spider2/rl_data_spider2/locating_tables/single_table_train.parquet",
        "val_files": "/efs/open_source_sql_agentic_rl/agent-lightning/examples/spider2/rl_data_spider2/locating_tables/stage2_single_table_val.parquet",
        "train_batch_size": 8,
    ...
    "trainer": {
        ...
        "experiment_name": "spider_stage2_single_table",
        "default_local_dir": '/efs/open_source_sql_agentic_rl/agent-lightning/examples/spider2/stage2_single_table/',
        "nnodes": 2,
        "test_freq": 5,
        "save_freq": 5,
        "total_epochs": 100,
