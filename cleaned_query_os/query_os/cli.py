...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    agent = QueryOS(
        ...
        schema_parallel_timeout_seconds=float(cfg_get(config, "schema_discovery.parallel_timeout_seconds", 0)),
        ...
        sql_parallel_timeout_seconds=float(cfg_get(config, "sql_writer.parallel_timeout_seconds", 0)),
